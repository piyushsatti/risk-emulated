...
<<<<<<< Updated upstream
        ...
        Reinforcement l_rf = new Reinforcement(l_ge);
        l_rf.run();
        Deploy l_deploy = new Deploy(l_ge.d_players.get(0), l_ge.d_players.get(0).getName(), l_ge.d_players.get(0).getPlayerId(), l_ge.d_players.get(0).getAssignedCountries().get(0), 15, l_ge);
        l_deploy.execute();
=======
        GameEngine ge = new GameEngine();
        MapInterface mp = null;
