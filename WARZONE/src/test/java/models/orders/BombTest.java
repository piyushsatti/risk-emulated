...
public class BombTest {
    ...
    public void validateCommandTests1() {
        ...
        // Validate command
        Bomb l_b = new Bomb(l_ge.d_players.get(0), l_ge.d_players.get(1), l_ge.d_players.get(0).getPlayerId(), l_ge.d_players.get(0).getName(), l_ge.d_players.get(1).getAssignedCountries().get(0), l_ge);
        assertTrue(l_b.validateCommand());
    }
    ...
    public void validateCommandTests2() {
        ...
        // Validate command
        Bomb l_b = new Bomb(l_ge.d_players.get(0), l_ge.d_players.get(1), l_ge.d_players.get(0).getPlayerId(), l_ge.d_players.get(0).getName(), l_ge.d_players.get(0).getAssignedCountries().get(1), l_ge);
        assertFalse(l_b.validateCommand());
    }
    ...
    public void orderValidationTest1() {
        ...
        Reinforcement l_rf = new Reinforcement(l_ge);
        l_rf.run();
        Deploy deploy = new Deploy(l_ge.d_players.get(0), l_ge.d_players.get(0).getName(), l_ge.d_players.get(0).getPlayerId(), l_ge.d_players.get(0).getAssignedCountries().get(0), 4, l_ge);
        deploy.execute();
        ...
        assertEquals(2, l_c.getReinforcements());
    }
    ...
    public void orderValidationTest2() {
        ...
        Reinforcement l_rf = new Reinforcement(l_ge);
        l_rf.run();
        Deploy deploy = new Deploy(l_ge.d_players.get(0), l_ge.d_players.get(0).getName(), l_ge.d_players.get(0).getPlayerId(), l_ge.d_players.get(0).getAssignedCountries().get(0), 15, l_ge);
        deploy.execute();
        ...
        assertNotEquals(10, l_c.getReinforcements());
    }
}
