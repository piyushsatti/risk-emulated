...
//     * @param p_listOfPlayers list of players participating in the game.
//     */
////    public static void assignReinforcements(GameEngine ge, Player player){
...
////                int bonus = continent.getBonus(); // Get the bonus value
////                System.out.println("All countries of " + continent.getContinentName() + " are present. Bonus: " + bonus);
////            } else {
////                // Not all countries of the continent are present
////                System.out.println("Not all countries of " + continent.getContinentName() + " are present in the player's assigned countries.");
////            }
////        }
////
