...
public class DuplicateContinentException extends Exception {
     ...
     */
    public DuplicateContinentException(int p_id) {
        super("Continent " + p_id + " already exists");
    }
     ...
     */
    public DuplicateContinentException(String p_name) {
        super("Continent " + p_name + " already exists");
    }
}
